...
class SelfHomePage extends StatefulWidget {
  String aadharNumber;
  SelfHomePage({Key key, this.aadharNumber}) : super(key: key);
    ...
    try {
      if (aadharNo.length == 12) {
        ...
        if (data != null) {
          ...
          try {
            print("FAMILY AADHAR NUMBERS: " + data['family_aadhar'].toString());
          } catch (e) {
            print("EXCEPTION family_aadhar field not found...");
          }
          try {
            p1Stat = data['p1_status'];
          } catch (StateError) {
            print("p1 status not found... set p1 status = false");
            p1Stat = false;
          }
          ...
          setState(() {
            ...
            dataNotFound = false;
            try {
              memberAadharNumberLength = data['family_aadhar'].length;
              print("LENGTH OF Aadhar: " + memberAadharNumberLength.toString());
            } catch (e) {
              print(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.only(
                                left: SizeConfig.screenWidth / 15.0),
                            child: Row(
                              children: <Widget>[
                                Text(
                                  "Fill Phase 1 & 2 form",
